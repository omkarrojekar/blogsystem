                            ...
                            <div class="col-12">
                                ...
                                <?php endif; ?>   
                                    ...
                                    <hr>
                                            ...
                                            <div class="p-20">
                                                <form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>admin/upload" enctype="multipart/form-data">
                                                     ...
                                                     <div class="form-group row">
                                                       ...
                                                       <div class="col-xl-12">
                                                         <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-10 col-sm-12">
                                                                <textarea  id="body" name="body" class="form-control summernote" rows="10"><?php echo set_value('body'); ?></textarea>
                                                      ...
                                                      <div class="col-xl-12">
                                                         <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-10 col-sm-12">
                                                                <textarea  id="description" name="description" class="form-control" rows="6" placeholder="Description"><?php echo set_value('description'); ?></textarea>
                                                      ...
                                                      <div class="col-xl-12">
                                                         <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-10 col-sm-12">
                                                                 <input type="text" placeholder="Add Tags" data-role="tagsinput" class="form-control" name="tags" value="<?php echo set_value('tags'); ?>"/>
                                                        ...
                                                        <div class="col-xl-12">
                                                         <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-10 col-sm-12">
                                                                 <input type="text" placeholder="Add Keywords" data-role="tagsinput" class="form-control" name="keywords" value="<?php echo set_value('keywords'); ?>"/>
                                                                 <?php echo form_error('tags', '<div class="error" style="color:red;">', '</div>'); ?>
                                                            </div>
                                                         </div>
                                                      </div>
                                                       <div class="col-xl-12">
                                                         <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-10 col-sm-12">
                                                                <textarea  id="mini_description" name="mini_description" class="form-control" rows="2" placeholder="Mini Description"><?php echo set_value('mini_description'); ?></textarea>
                                                      ...
                                                      <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-10 col-sm-12">
                                                            <select class="form-control" id="allow" name="allow">
                                                                ...
                                                                <option value="yes" <?php if(isset($_POST['allow']) && $_POST['allow'] == "yes") echo 'selected="selected"';?>>Yes</option>
                                                                <option value="no" <?php if(isset($_POST['allow']) && $_POST['allow'] == "no") echo 'selected="selected"';?>>No</option>
                                                            </select>
