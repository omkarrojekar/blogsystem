                                    ...
                                    <div id="portlet2" class="panel-collapse collapse show">
                                        <div class="portlet-body">
                                           ...
                                           <div class="container" id="tourpackages-carousel">
                                              <div class="row">
                                                <?php foreach ($getAllUserPostedBlogs as $row): ?>
                                                <div class="col-xs-12 col-sm-6 col-md-3">
                                                  <div class="thumbnail">
                                                   <a href="<?php echo base_url()?>blogs/view/<?= $row->url; ?>"> <img src="<?php echo base_url(); ?>upload/<?php echo $row->image; ?>" alt="" class="img  img-responsive"></a>
                                                      <div class="caption">
